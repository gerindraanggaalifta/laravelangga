...
<body id="page-top">
  ...
  <header class="masthead bg-primary text-white text-center">
    <div class="container">
      ...
      <h1 class="text-uppercase mb-0">Gerindra Angga Alifta</h1>
      <hr class="star-light">
      <h2 class="font-weight-light mb-0">173140914111030 - MIB</h2>
    </div>
  </header>
  ...
  <script src="{{ asset('abc/vendor/jquery/jquery.min.js') }}"></script>
  <script src="{{ asset('abc/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>

  <!-- Plugin JavaScript -->
  <script src="{{ asset('abc/vendor/jquery-easing/jquery.easing.min.js') }}"></script>
  <script src="{{ asset('abc/vendor/magnific-popup/jquery.magnific-popup.min.js') }}"></script>

  <!-- Contact Form JavaScript -->
  <script src="{{ asset('abc/js/jqBootstrapValidation.js') }}"></script>
  <script src="{{ asset('abc/js/contact_me.js') }}"></script>
